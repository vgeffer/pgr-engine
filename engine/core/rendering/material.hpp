...
#include "../runtime/refcounter.hpp"
...
namespace rendering {
    ...
    class material {
        ...
        public:
            ...
            inline std::unordered_map<uint32_t, std::shared_ptr<pgreng::assets::shader_stage>>& shader_stages() { return m_shader_stages; }
        ...
        private:
            ...
            std::array<std::shared_ptr<pgreng::assets::texture>, 2> m_specular_textures;
            std::array<std::shared_ptr<pgreng::assets::texture>, 2> m_diffuse_textures;
            std::array<std::shared_ptr<pgreng::assets::texture>, 2> m_normal_maps;
            std::array<std::shared_ptr<pgreng::assets::texture>, 2> m_blend_maps;

            std::unordered_map<uint32_t, std::shared_ptr<pgreng::assets::shader_stage>> m_shader_stages;
            utils::gpu_allocator::handle m_buffer_handle;
            int m_material_index;
        };

    struct mat : public refcounter<material> {};
}
