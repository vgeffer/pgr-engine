...
NLOHMANN_JSON_SERIALIZE_ENUM(pgreng::window::video_mode::window_mode, {
    {pgreng::window::video_mode::window_mode::WINDOW, "windowed"},
    {pgreng::window::video_mode::window_mode::BORDERLESS, "borderless"},
    {pgreng::window::video_mode::window_mode::FULLSCREEN, "fullscreen"}
});

NLOHMANN_JSON_SERIALIZE_ENUM(pgreng::window::video_mode::aa_level, {
    {pgreng::window::video_mode::aa_level::OFF, 0},     {pgreng::window::video_mode::aa_level::MSAAx2, 2},
    {pgreng::window::video_mode::aa_level::MSAAx4, 4},  {pgreng::window::video_mode::aa_level::MSAAx8, 8},
});